...
**步骤 2** &#160; &#160; 在弹出的共享模型输入框中“发布者名称”输入用户名称，名称形式为：<font color=red>**姓名-电话号码**</font>（姓名和电话号码用于竞赛结果发布和颁奖确认）。“共享的用户”选择请输入用户ID”，<font color=red>**输入竞赛公共账号ID 4be227f2f9a54524b5464ed32785365c**</font>，然后点击“共享”将模型共享给竞赛公共账号。
